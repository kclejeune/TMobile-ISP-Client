...
<div class="z-50 h-full shadow drawer drawer-mobile">
  ...
  <div class="flex flex-col drawer-content">
    <div class="fixed top-0 z-50 w-full navbar bg-base-300 inline-flex">
      ...
      {/if}
      <div class="flex-none">
        <a href="https://github.com/kclejeune/tmobile-isp-client">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
            data-icon="github"
            class="svg-inline--fa fa-github fa-w-16 h-6 w-6"
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 496 512"
          >
      ...
      <div class="flex-none">
        <div class="mx-4 text-lg">{currentPage.title}</div>
      </div>
    </div>
    <slot />
  </div>
